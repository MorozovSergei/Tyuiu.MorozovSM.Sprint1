...
namespace Tyuiu.MorozovSM.Sprint1.Task2.V14
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("***************************************************************************");
            int x ;
            Console.WriteLine("Введите градусы по кельвину");
            x = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("* РЕЗУЛЬТАТ:                                                              *");
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("Это равно по цельсию "+ds.ConvertKelvinToCelsius(x));
            Console.ReadKey();
        }
    }
}
